...
def to_volcengine_generation_params(
    ...
    *,
    ...
    """Convert an aiflect generation request into Ark Responses API parameters."""
    ...
    if session_cache_enabled and request.response_format is not None:
        raise UnsupportedCapabilityError(
            ...
            "aiflect maps it to json_schema; omit RemoteContextHint.session_key or disable "
...
def from_volcengine_generation_response(response: Any) -> GenerationResponse:
    """Convert an Ark Responses API response into an aiflect response."""
