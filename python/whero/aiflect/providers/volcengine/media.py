...
from whero.aiflect.providers.volcengine.mapper import PROVIDER
...
def to_volcengine_image_params(
    ...
    *,
    ...
    """Convert an aiflect image request into Ark Images API parameters."""
...
def from_volcengine_image_response(response: Any) -> ImageGenerationResponse:
    """Convert an Ark Images API response into an aiflect response."""
...
def to_volcengine_video_task_create_params(request: VideoGenerationRequest) -> dict[str, Any]:
    """Convert an aiflect video request into Ark content generation task parameters."""
...
def from_volcengine_video_task(task: Any) -> MediaGenerationTask:
    """Convert an Ark content generation task into an aiflect task."""
...
def from_volcengine_video_task_create_response(
    ...
    *,
    ...
    """Convert an Ark task-create id response into a queued aiflect task."""
