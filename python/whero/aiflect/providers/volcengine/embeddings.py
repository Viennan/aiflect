...
from whero.aiflect.core.items import ImagePart, TextPart, VideoPart
...
def to_volcengine_embedding_params(request: EmbeddingRequest) -> dict[str, Any]:
    """Convert an aiflect embedding request into Ark multimodal embedding parameters."""
...
def from_volcengine_embedding_response(response: Any) -> EmbeddingResponse:
    """Convert an Ark multimodal embedding response into an aiflect response."""
