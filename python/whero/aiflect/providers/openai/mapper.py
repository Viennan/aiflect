...
def to_openai_generation_params(
    ...
    *,
    ...
    """Convert an aiflect generation request into OpenAI Responses API parameters."""
...
def to_openai_embedding_params(request: EmbeddingRequest) -> dict[str, Any]:
    """Convert an aiflect embedding request into OpenAI embedding parameters."""
...
def from_openai_generation_response(response: Any) -> GenerationResponse:
    """Convert an OpenAI Responses API response into an aiflect response."""
...
def from_openai_embedding_response(response: Any) -> EmbeddingResponse:
    """Convert an OpenAI embedding response into an aiflect embedding response."""
