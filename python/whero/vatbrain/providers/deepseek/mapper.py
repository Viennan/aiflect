...
def to_deepseek_generation_params(
    ...
    *,
    ...
    """Convert a vatbrain generation request into DeepSeek Anthropic-compatible parameters."""
...
def from_deepseek_generation_response(response: Any) -> GenerationResponse:
    """Convert a DeepSeek Anthropic-compatible response into a vatbrain response."""
