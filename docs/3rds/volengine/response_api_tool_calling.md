...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="EbmOdBCLdG"><RenderMd content={`**第一轮请求： 触发工具调用**
\`\`\`Bash
...
<Tabs.TabPane title="Python" key="xeL2TkvwUC"><RenderMd content={`\`\`\`Python
import os
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="rRka1hoBl2"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="N0pQW4Jhvs"><RenderMd content={`\`\`\`Java
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="OpenAI SDK" key="xvshw7gfqO"><RenderMd content={`\`\`\`Python
import os
